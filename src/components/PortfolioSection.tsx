        ...
        {selectedImage && (
          <DialogPortal>
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-8 bg-background/95 backdrop-blur-xl cursor-zoom-out"
            ...
            >
              <Button
                ...
                variant="ghost"
                size="icon"
                className="fixed top-6 right-6 z-[210] rounded-full bg-red-600 hover:bg-red-700 text-white transition-all duration-300 shadow-2xl hover:scale-110 border-2 border-white/20 group/close cursor-pointer pointer-events-auto w-12 h-12"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
