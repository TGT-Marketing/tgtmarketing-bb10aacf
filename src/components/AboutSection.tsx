...
import guilhermeTgt from "@/assets/guilherme-tgt.jpg";
      ...
      <div className="container-main" ref={ref}>
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 items-center">
          ...
          >
            ...
            <h1 className="text-2xl sm:text-5xl lg:text-7xl font-black text-foreground mt-3 mb-6 leading-[1.2] sm:leading-[1.1] tracking-tight">
          ...
          >
            ...
            >
              ...
              <img
                ...
                loading="lazy"
                decoding="async"
                className="w-full h-[320px] sm:h-[420px] object-cover object-[center_5%] transition-transform duration-700 ease-out group-hover:scale-110 aspect-[3/4] sm:aspect-auto"
              />
