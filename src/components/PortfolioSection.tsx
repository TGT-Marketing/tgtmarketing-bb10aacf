...
const portfolioItems = [
  {
    ...
    description:
      "Gestão completa das suas redes sociais com conteúdo estratégico, calendário editorial e interação com o público. Posicionamos sua marca como autoridade no seu segmento.",
    deliverables: [
  ...
  },
  {
    ...
    description:
      "Campanhas estratégicas no Google Ads e Meta Ads que geram leads qualificados e vendas reais. Monitoramento constante e otimização para maximizar seu ROI.",
    deliverables: [
  ...
  },
  {
    ...
    description:
      "Desenvolvemos identidades visuais que comunicam a essência da sua marca. Do logotipo ao manual de marca completo, cada detalhe é pensado para diferenciar seu negócio no mercado.",
    deliverables: [
  ...
  },
  {
    ...
    description:
      "Sites modernos, responsivos e otimizados para conversão. Criamos experiências digitais que representam sua marca com excelência e transformam visitantes em clientes.",
    deliverables: [
  ...
  },
  {
    ...
    description:
      "Lojas virtuais completas e otimizadas para vender. Do layout à integração com meios de pagamento e logística, cuidamos de tudo para seu e-commerce decolar.",
    deliverables: [
  ...
  },
  {
    ...
    description:
      "Produção profissional de vídeos, fotos e materiais visuais que fortalecem sua marca. Conteúdos com qualidade cinematográfica para redes sociais, sites e campanhas.",
    deliverables: [
      ...
      <div className="container-main">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-[15px]">
            Mais de uma década de projetos entregues com excelência. Cada
            trabalho é uma prova de que estratégia e criatividade geram
            resultados.
          </p>
        </motion.div>
          ...
          {portfolioItems.map((item, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6">
                <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-accent mb-1">
                  {item.category}
                </span>
                <h3 className="text-xl font-bold text-primary-foreground group-hover:text-accent transition-colors duration-300">
                  {item.title}
                </h3>
                <span className="inline-flex items-center gap-1 text-primary-foreground/50 text-sm mt-2 group-hover:text-accent/70 group-hover:gap-2 transition-all duration-300">
          ...
          {selectedItem && (
            <>
              ...
              <div className="px-6 pb-6 space-y-5">
                ...
                <div>
                  <h4 className="text-xs font-bold text-foreground uppercase tracking-[0.15em] mb-3">
                    O que entregamos
                  </h4>
