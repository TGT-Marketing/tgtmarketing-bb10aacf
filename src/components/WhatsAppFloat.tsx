...
const WhatsAppFloat = () => {
  ...
  return createPortal(
    ...
    >
      ...
      />
      <svg viewBox="0 0 32 32" fill="white" className="w-6 h-6 sm:w-7 sm:h-7 relative z-10 shrink-0">
      ...
      <span className="text-sm sm:text-base font-bold relative z-10 pr-1">Falar no WhatsApp</span>
    </motion.a>,
    document.body,
  );
};
