          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4 mt-4">
                ...
                <a href="https://www.tiktok.com/@acertandonoalvo" target="_blank" rel="noopener noreferrer" className="text-section-dark-foreground/50 hover:text-accent transition-colors">
